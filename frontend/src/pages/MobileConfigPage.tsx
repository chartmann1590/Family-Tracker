        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Choose your mobile app and follow the setup instructions
            </p>
          </div>
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-3">
                      Our official Android app provides the best experience for Family Tracker. It includes
                      real-time location sharing, family messaging, and an interactive map - all in one beautiful app.
                    </p>
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-primary-600">
                        <CheckCircle className="w-4 h-4" />
                        <span>Background location updates</span>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div className="flex items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg bg-white">
                        <div className="text-center">
                          <QRCodeSVG
                            ...
                            includeMargin={true}
                          />
                          <p className="text-sm text-gray-600 mt-2">Scan to Download</p>
                        </div>
                      </div>
                    </div>

                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      <h3 className="font-semibold text-gray-900 mb-2">Installation Steps:</h3>
                      <ol className="space-y-2 text-sm text-gray-700">
                        ...
                        <li className="flex gap-2">
                          ...
                          <span>Wait for installation to complete and tap "Open"</span>
                        </li>
                      </ol>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 mb-4">
                      When you first open the app, you'll be asked to enter your server information:
                    </p>
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        ...
                        />
                        <button
                          onClick={() => copyToClipboard(window.location.host, 'serverUrl')}
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        Enter this in the app when prompted. The app will test the connection before continuing.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3 text-gray-700">
                      <p>After configuring the server:</p>
                      <ol className="space-y-2 ml-4">
                        <li className="flex gap-2">
                          <span className="font-bold text-primary-600">1.</span>
                          <span>Login with your existing account or register a new one</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="font-bold text-primary-600">2.</span>
                          <span>Grant location permissions when prompted (required for tracking)</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="font-bold text-primary-600">3.</span>
                          <span>Your location will automatically appear on the family map</span>
                        </li>
                        <li className="flex gap-2">
                          <span className="font-bold text-primary-600">4.</span>
                          <span>Use the messaging feature to chat with family members</span>
                        </li>
                      </ol>
                    </div>
                  </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <div className="space-y-4 text-sm text-gray-700">
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Can't Install APK?</h3>
                        <ul className="space-y-1 ml-4">
                          <li>• Enable "Install from Unknown Sources" in Android Settings</li>
                          <li>• Make sure you downloaded the complete file</li>
                          <li>• Try downloading again if the file is corrupted</li>
                        </ul>
                      </div>

                      <div>
                        <h3 className="font-semibold text-gray-900 mb-2">Can't Connect to Server?</h3>
                        <ul className="space-y-1 ml-4">
                          <li>• Make sure your device is on the same network as the server</li>
                          <li>• Check that the server URL is correct (use IP:port format)</li>
                          <li>• Verify the server is running and accessible</li>
                          <li>• You can change the server URL later in Settings</li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-1 ml-4">
                          <li>• Check location permissions in Android Settings</li>
                          <li>• Enable "Allow all the time" for background tracking</li>
                          <li>• Make sure the app is not being battery-optimized</li>
                          <li>• Check the Settings menu in the app to view logs</li>
                        </ul>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="ml-4">
                          Use the "Email Logs" feature in the app's Settings menu to send diagnostic information.
                        </p>
                      </div>
                    </div>
                  </div>
